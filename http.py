...
url = 'akabab.github.io/superhero-api/api'
...
content_Captain = json.loads(requests.get('https://www.superheroapi.com/api.php/2619421814940190/search/Captain').content)
